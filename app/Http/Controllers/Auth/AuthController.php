...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if ($user->organization && !$user->organization->is_verified === false) {
        // Logout / batasi session jika menggunakan Web Auth
        Auth::logout();

        return response()->json([
            'message' => 'Akun berhasil diverifikasi kredensialnya, namun organisasi Anda belum terverifikasi oleh Admin.',
